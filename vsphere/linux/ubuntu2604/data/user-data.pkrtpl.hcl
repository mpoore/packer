...
%{ if build_guestos_packages != "" ~}
    - curtin in-target --target=/target -- apt-get install -y ${build_guestos_packages}
%{ endif ~}
%{ if salt_version != "" ~}
    - curtin in-target --target=/target -- apt-get install -y salt-minion=${salt_version} salt-common=${salt_version}
%{ else ~}
    - curtin in-target --target=/target -- apt-get install -y salt-minion salt-common
%{ endif ~}