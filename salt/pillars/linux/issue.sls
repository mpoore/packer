# ----------------------------------------------------------------------------
# Name:         salt/pillars/linux/issue.sls
# Description:  Salt pillar file for linux issue file configuration
...
issue_contents: |
  Welcome to:                                                                ░██
    ...
    * All activity may be monitored, recorded, and subject to audit.          *
