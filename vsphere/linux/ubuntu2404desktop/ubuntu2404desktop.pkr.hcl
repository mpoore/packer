# ----------------------------------------------------------------------------
# Name:         ubuntu2404desktop.pkr.hcl
# Description:  Build definition for Ubuntu 24.04 Desktop LTS
...
# -------------------------------------------------------------------------- #
source "vsphere-iso" "ubuntu2404desktop" {
    # vCenter
...
build {
    # Build sources
    sources                 = [ "source.vsphere-iso.ubuntu2404desktop" ]
