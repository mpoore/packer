# ----------------------------------------------------------------------------
# Name:         ubuntu2604.auto.pkrvars.hcl
# Description:  Required vSphere variables for Ubuntu 26.04 LTS Packer builds
# Author:       Michael Poore (@mpoore)
# URL:          https://github.com/mpoore/packer
# ----------------------------------------------------------------------------

# ISO Settings
os_iso_file                     = "ubuntu-26.04-live-server-amd64.iso"
os_iso_path                     = "os/ubuntu/26"

# OS Meta Data
meta_os_family                  = "Linux"
meta_os_type                    = "Server"
meta_os_vendor                  = "Ubuntu"
meta_os_version                 = "26.04 LTS"
